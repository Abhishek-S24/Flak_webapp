...
#Route where it will ask for company name and adress.
...
#Route for searching Employee details using employee id.

@app.route('/search',methods=['POST','GET'])
def search():
    if request.method == 'POST':
        searched=request.form['search']
        search_data= Data.query.filter(Data.empID.like(searched)).first()

        return render_template("index.html", employees = search_data)
